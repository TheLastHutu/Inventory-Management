<template>
  <el-drawer title="送货单详情" :visible.sync="visible" direction="rtl" size="60%" append-to-body :before-close="handleClose" custom-class="detail-drawer">
    <div v-loading="loading" class="drawer-content">
      <h4 class="section-header">基本信息</h4>
      <el-row :gutter="20" class="mb8">
        <el-col :span="12">
          <div class="info-item">
            <label class="info-label">送货单号：</label>
      ...
      <el-row :gutter="20" class="mb8">
        <el-col :span="12">
          <div class="info-item">
            <label class="info-label">发货仓库：</label>
            <span class="info-value plaintext">
      ...
      <el-row :gutter="20" class="mb8">
        ...
        <el-col :span="12">
          <div class="info-item">
            <label class="info-label">送货日期：</label>
            <span class="info-value plaintext">
      ...
      <el-row :gutter="20" class="mb8">
        <el-col :span="12">
          <div class="info-item">
            <label class="info-label">送货类型：</label>
            <span class="info-value plaintext">
              {{ info.deliveryType }}
            </span>
          </div>
      ...
      <el-table :data="info.imsDeliveryItemList || []" border size="small" class="detail-table">
