<template>
  <el-drawer title="入库单详情" :visible.sync="visible" direction="rtl" size="60%" append-to-body :before-close="handleClose" custom-class="detail-drawer">
    <div v-loading="loading" class="drawer-content">
      ...
      <el-row :gutter="20" class="mb8">
        <el-col :span="12">
          <div class="info-item">
            <label class="info-label">入库类型：</label>
            <span class="info-value plaintext">
              <dict-tag :options="dict.type.ims_inbound" :value="info.inType" />
            </span>
          </div>
        </el-col>
        <el-col :span="12">
      ...
      <el-table :data="info.imsInboundItemList || []" border size="small" class="detail-table">
