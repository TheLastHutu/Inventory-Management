<template>
  <el-drawer title="报损单详情" :visible.sync="visible" direction="rtl" size="60%" append-to-body :before-close="handleClose" custom-class="detail-drawer">
    <div v-loading="loading" class="drawer-content">
      <h4 class="section-header">基本信息</h4>
      <el-row :gutter="20" class="mb8">
        <el-col :span="12">
          <div class="info-item">
            <label class="info-label">报损单号：</label>
      ...
      <el-row :gutter="20" class="mb8">
        ...
        <el-col :span="12">
          <div class="info-item">
            <label class="info-label">报损日期：</label>
            <span class="info-value plaintext">
      ...
      <el-row :gutter="20" class="mb8">
        <el-col :span="12">
          <div class="info-item">
            <label class="info-label">报损原因：</label>
            <span class="info-value plaintext">
              {{ info.reason }}
            </span>
          </div>
      ...
      <el-row :gutter="20" class="mb8">
        <el-col :span="12">
          <div class="info-item">
            <label class="info-label">总金额(按成本)：</label>
            <span class="info-value plaintext">
              {{ info.totalAmount }}
            </span>
          </div>
      ...
      <el-table :data="info.imsDamageItemList || []" border size="small" class="detail-table">
        ...
        <el-table-column label="成本单价" align="right" prop="costPrice" />
