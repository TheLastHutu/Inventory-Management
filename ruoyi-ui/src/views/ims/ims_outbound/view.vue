<template>
  <el-drawer title="出库单详情" :visible.sync="visible" direction="rtl" size="60%" append-to-body :before-close="handleClose" custom-class="detail-drawer">
    <div v-loading="loading" class="drawer-content">
      <h4 class="section-header">基本信息</h4>
      <el-row :gutter="20" class="mb8">
        <el-col :span="12">
          <div class="info-item">
            <label class="info-label">出库单号：</label>
        ...
        <el-col :span="12">
          <div class="info-item">
            <label class="info-label">出库日期：</label>
            <span class="info-value plaintext">
      ...
      <el-row :gutter="20" class="mb8">
        <el-col :span="12">
          <div class="info-item">
            <label class="info-label">出库类型：</label>
            <span class="info-value plaintext">
              <dict-tag :options="dict.type.ims_outbound" :value="info.outType" />
            </span>
          </div>
        </el-col>
        <el-col :span="12">
      ...
      <el-row :gutter="20" class="mb8">
        <el-col :span="12">
          <div class="info-item">
            <label class="info-label">经手人：</label>
            <span class="info-value plaintext">
              {{ employeeName(info.handlerId) }}
            </span>
          </div>
        </el-col>
        <el-col :span="12">
      ...
      <el-table :data="info.imsOutboundItemList || []" border size="small" class="detail-table">
        ...
        <el-table-column label="单价" align="right" prop="unitPrice" />
